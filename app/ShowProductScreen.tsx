...
const ShowProductScreen: FC = () => {
  ...
  const buyProduct = (whatsapp: string, instagramId: string, facebookId: string) => {
    setContact({
      ...
      {isBuy ? (
        <View style={styles.modalContainer}>
          <View style={styles.box}>
            <TouchableOpacity onPress={() => setIsBuy(false)} style={styles.cancel}>
              <AntDesign name="close" size={30} color="black" />
            </TouchableOpacity>
            <Text style={[styles.sellerText, styles.title]}>Contact the seller through this media:</Text>
            {contact.phoneNumber !== '' && (
              <MediaComponent
